...
export default function PollDetailDailog(props) {
  const classes = useStyles();
  console.log("PollDetailDailog -> ", props.data);
  ...
  return (
    <div className={classes.root}>
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        <ToastContainer />
        {/* <CircularProgress /> */}
        <DialogTitle id="form-dialog-title">Create poll { props.data.title}</DialogTitle>
        <DialogContent>
          <DialogContentText>
            Poll details view here.
          </DialogContentText>
